        ...
        <aside class="col-12 col-lg-3 mb-4">
          <div class="card shadow-sm p-3">
            ...
            <div class="mb-3">
              ...
              <select class="form-select" v-model="filters.pickupLocation">
            ...
            <div class="mb-3">
              ...
              <select class="form-select" v-model="filters.dropoffLocation">
                <option value="">Bitte wählen</option>
                <option value="widnau">Widnau</option>
                <option value="stgallen">St. Gallen</option>
              </select>
  ...
  computed:{
    products() {
        return [
                ...
                'seller': {
                            id:1,
                            name: 'Avesome company 1'
                            },
                'features': '<li>black color</li><li>pink color</li>',
                'available': 2,
                'freeDelivery': true,
                ...
                'description': 'Product features description-3',
                'seller': {
                        id:2,
                        name: 'Avesome company 3'
                        },
                'features': '<li>black color</li>',
                'available': 4,
                'freeDelivery': true,
                'deliveryIn': 'in 2 days',
                'price': 78,
                'moneySymbol': '€'
                },
{
                ...
                'description': 'Product features description-4',
                'seller': {
                            id:1,
                            name: 'Avesome company 4'
                            },
                'features': '<li>black color</li>',
                'available': 2,
                'freeDelivery': true,
                ...
                {
                'image': '/images/kia-ev4.jpg',
                'name': 'Awesome Product 5',
                'description': 'Product features description-5',
                'seller': {
                        id:2,
                        name: 'Avesome company 5'
                        },
                'features': '<li>black color</li>',
                'available': 3,
                'freeDelivery': true,
                ...
                {
                'image': '/images/skoda-karoq.jpg',
                'name': 'Awesome Product 3',
                'description': 'Product features description-6',
                'seller': {
                        id:2,
                        name: 'Avesome company 6'
                        },
                'features': '<li>black color</li>',
                'available': 4,
                'freeDelivery': true,
